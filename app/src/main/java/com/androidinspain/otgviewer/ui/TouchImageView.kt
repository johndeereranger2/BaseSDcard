...
class TouchImageView : ImageView {
    ...
    private fun savePreviousImageValues() {
        if (matrix1 != null && viewHeight != 0 && viewWidth != 0) {
            matrix1!!.getValues(m)
    ...
    public override fun onSaveInstanceState(): Parcelable? {
        ...
        matrix1!!.getValues(m)
        bundle.putFloatArray("matrix1", m)
    ...
    private fun fitImageToView() {
        ...
        if (matrix1 == null || prevMatrix == null) {
            return
        }
        val drawableWidth = drawable.intrinsicWidth
        val drawableHeight = drawable.intrinsicHeight
        ...
        if (!isZoomed && !imageRenderedAtLeastOnce) {
            ...
            matrix1!!.postTranslate(redundantXSpace / 2, redundantYSpace / 2)
            currentZoom = 1f
        } else {
            //
    ...
    private fun scaleImage(
        ...
        matrix1!!.postScale(deltaScale.toFloat(), deltaScale.toFloat(), focusX, focusY)
        fixScaleTrans()
    }
    ...
    private inner class DoubleTapZoom internal constructor(
        ...
        private fun translateImageToCenterTouchPosition(t: Float) {
            ...
            matrix1!!.postTranslate(targetX - curr.x, targetY - curr.y)
        }
    ...
    private inner class Fling internal constructor(velocityX: Int, velocityY: Int) :
        ...
        override fun run() {
            ...
            if (scroller!!.computeScrollOffset()) {
                ...
                currX = newX
                currY = newY
                matrix1!!.postTranslate(transX.toFloat(), transY.toFloat())
                fixTrans()
                imageMatrix = matrix1
                compatPostOnAnimation(this)
            }
        ...
        init {
            ...
            scroller = CompatScroller(context1)
            matrix1!!.getValues(m)
